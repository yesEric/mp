...
<head>
    ...
    <name><decorator:name/> | <fmt:message key="webapp.name"/></name>
    ...
    <script type="text/javascript" src="<c:url value='/scripts/lib/jquery-1.10.2.min.js'/>"></script>
...
<!-- 这里是程序菜单部分 -->
<div class="container">
    <h1 class="page-header">Barner
        <small>Resize Response</small>
    </h1>
    <div class="navbar">
        <div class="navbar-inner"><a href="#" class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
            <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </a> <a
                href="#" class="brand"> Bootstrap</a>

            <div class="nav-collapse">
                <ul class="nav">
                    <li class="active"><a href="#">HomePage</a></li>
                    <li><a href="#">Item1</a></li>
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Item2 </a>
